        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="checkout_hosted.php" method="POST" class="needs-validation">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="total_amount" placeholder="1500" name="amount"
                          required>
                    <div class="invalid-feedback">
                        Please enter amount
                    </div>
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <!-- <input type="hidden" value="1600" name="amount" id="total_amount" required/> -->
